...
class CreateLineFragment : Fragment() {
    ...
    private lateinit var edtShortnameGroupofLines: EditText
    ...
    override fun onCreateView(
        ...
        edtShortnameGroupofLines = rootView.findViewById(R.id.f_create_line_edt_shortname)
        edtStatus = rootView.findViewById(R.id.f_create_line_edt_status)
    ...
    fun saveLine() {
        activity?.onLineCreated(
                Line(
                        edtNameLine.text.toString(),
                        edtShortnameGroupofLines.text.toString(),
